...
class Monster(Character):
    def __init__(self, name, hp, monster_type):
...
class Zombie(Character):
    def __init__(self, name, armor=None, weapon=None, hp=50):
        super().__init__(name, armor, weapon, hp)

class Goblin(Character):
    def __init__(self, name, armor=None, weapon=None, hp=75):
        super().__init__(name, armor, weapon, hp)

class Dragon(Character):
    def __init__(self, name, armor=None, weapon=None, hp=150):
        super().__init__(name, armor, weapon, hp)
...
class Map:
    ...
    def generate_map(self):
            ...
            for i in range(1, self.num_rooms):
                monster_type = random.choice(monster_types[:-1])
