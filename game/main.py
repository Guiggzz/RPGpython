...
if type_choose == "1":
    ...
    jane = Wizard("Jane", user_armor, 75, user_armor.defense)
...
if type_choose == "1":
    if armor_condition and weapon_condition:
        ...
        if armor_condition : 
            print(f'\nVous avez : \n un batôn qui met 20 de dégats et une {user_armor.name} qui à {user_armor.defense} de défense pour vous protéger')
